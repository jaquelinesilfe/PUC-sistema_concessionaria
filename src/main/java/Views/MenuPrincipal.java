...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        InternalCadastroVeiculo cadastroveiculo = new InternalCadastroVeiculo();
        DesktopPane.add(cadastroveiculo);
        cadastroveiculo.setVisible(true);
    }//GEN-LAST:event_jMenuItem3ActionPerformed

    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        InternalVendaVeiculo vendaveiculo = new InternalVendaVeiculo();
        DesktopPane.add(vendaveiculo);
        vendaveiculo.setVisible(true);
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        InternalConsultaVeiculos consultaveiculos = new InternalConsultaVeiculos();
        DesktopPane.add(consultaveiculos);
